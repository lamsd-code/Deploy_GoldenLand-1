...
public class VnpayServiceImpl implements VnpayService {
    ...
    public ResponseDTO createPayment(TransactionCreateRequest req) {
        ...
        try {
            ...
            // ✅ Gán Customer và Building nếu có ID
            ...
            transactionRepository.save(tx); // ✅ Hibernate OK
            ...
            vnp_Params.put("vnp_Amount", String.valueOf(req.getAmount() * 100)); // VNPay yêu cầu nhân 100
